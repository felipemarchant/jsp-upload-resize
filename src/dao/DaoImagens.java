...
public class DaoImagens {
	...
	public DaoImagens() {
		connection = SingletonConnetion.getConnection(); //Obtem a conex�o com o banco de dados
	}
	...
	/**
	 * Retorna o registro consultado pelo c�digo passado por parametro
	 * @param cod
	 * @return Imagens
	 */
	...
	/**
	 * Constroi a instru��o para o banco de dados
	 * @param imagen
	 * @param insert
	 * @throws Exception
	 */
